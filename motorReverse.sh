...
gpio -g mode 23 up    #set internal pullup on GPIO 24 (pin 18)
gpio -g wfi 24 falling   #Watch the far limit switch for a toggle
gpio -g write 13 0    #Turn off the motor
gpio -g write 19 0    #Turn off the motor
sleep 1               #Wait for a second
gpio -g write 5 0     #Set the motor direction to reverse
gpio -g write 6 0     #Set the motor direction to reverse
gpio -g write 13 1    #Set the motor running
gpio -g write 19 1    #Set the motor running
gpio -g wfi 23 falling   #Watch the near limit switch for a toggle
gpio -g write 13 0    #Turn off the motor
gpio -g write 19 0    #Turn off the motor
sleep 1               #Wait for a second
gpio -g write 26 1    #Turn on the charging relay
